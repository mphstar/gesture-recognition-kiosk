...
import Ice1 from "../../../assets/images/Fantasy-Jeruk.png";
                    ...
                    <tr>
                      ...
                      <td className="text-left px-4">
                        <div className="flex flex-col lg:flex-row items-center gap-1 lg:gap-4">
                          ...
                          <div>Fantasy Apel</div>
                        </div>
                      </td>
                      <td className="text-left px-4">Rp. 5.000</td>
                      <td className="text-left px-4">
                        Ice with apple flavor can be enjoyed by the whole family. The delicious and refreshing taste of apples can make your body and throat feel fresh in hot weather
                      </td>
                      <td>
